...
public static List<StepParagraph> ToStepParagraphList(this List<StepParagraphPivot> stepParagraphPivotList)
{
return stepParagraphPivotList?.Select(x => x?.ToStepParagraph()).ToList();
