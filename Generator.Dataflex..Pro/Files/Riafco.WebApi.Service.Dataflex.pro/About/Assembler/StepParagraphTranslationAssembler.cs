...
/// </summary>
/// <param name="stepParagraphTranslationPivotList">stepParagraphTranslation dto list to assemble.</param>
...
/// </summary>
/// <param name="StepParagraphTranslationRequest"></param>
...
StepParagraphTranslationPivot = stepParagraphTranslationRequest.StepParagraphTranslationDto?.ToPivot(),
 FindStepParagraphTranslationPivot = Utility.EnumToEnum<FindStepParagraphTranslationDto, FindStepParagraphTranslationPivot>(stepParagraphTranslationRequest.FindStepParagraphTranslationDto)
};
}
 #endregion
...
/// </summary>
/// <param name="StepParagraphTranslationResponse">StepParagraphTranslation Response pivot to assemble.</param>
...
{
return null;}else{ return new StepParagraphTranslationMessage()
{
