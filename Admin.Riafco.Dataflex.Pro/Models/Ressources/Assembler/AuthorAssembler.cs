...
namespace Admin.Riafco.Dataflex.Pro.Models.Ressources.Assembler
{
    ...
    public static class AuthorAssembler
    {
        ...
        public static AuthorFormData ToFormData(this AuthorItemData itemData)
        {
            ...
            {
                AuthorFirstName = itemData.AuthorFirstName,
                AuthorLastName = itemData.AuthorLastName,
        ...
        public static AuthorFormData ToFormData(this AuthorRequestData authorRequestData)
        {
            ...
            return new AuthorFormData
            {
                AuthorFirstName = authorRequestData.AuthorDto.AuthorFirstName,
                AuthorLastName = authorRequestData.AuthorDto.AuthorLastName,
