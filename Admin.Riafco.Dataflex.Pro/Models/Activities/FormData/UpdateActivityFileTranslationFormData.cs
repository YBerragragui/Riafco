...
namespace Admin.Riafco.Dataflex.Pro.Models.Activities.FormData
{
    ...
    /// </summary>
    public class UpdateActivityFileTranslationFormData
    {
        /// <summary>
        /// Gets or Sets The TranslationId.
        /// </summary>
        [Range(1, int.MaxValue, ErrorMessageResourceType = typeof(FileResources), ErrorMessageResourceName = "RequiredFileTranslationActivityId")]
