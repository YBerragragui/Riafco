namespace Admin.Riafco.Dataflex.Pro
{
    /// <summary>
    ...
    public static class Constant
    {
        ...
        /// </summary>
        internal const string WebApiUrl = "http://localhost:5576/api/";
        ...
        /// </summary>
        internal const string DefaultWebApiUrl = "http://localhost:5576/api/";

        /// <summary>
        /// The url of the back hebergement.
        /// </summary>
        public const string DefaultBackUrl = "http://admin.riafco.org/";
        ...
        /// </summary>
        internal const string WebApiCreateStepParagraphs = "CreateStepParagraph";

        /// <summary>
        /// The update step paragraph method.
        /// </summary>
        internal const string WebApiUpdateStepParagraphs = "UpdateStepParagraph";

        /// <summary>
        /// The update step paragraph method.
        /// </summary>
        internal const string WebApiRemoveStepParagraphs = "RemoveStepParagraph";
        ...
        /// </summary>
        internal const string WebApiStepStepParagraphsList = "GetStepParagraphs";
        ...
        /// The step paragraph list action.
        /// </summary>
        internal const string WebApiStepParagraphTranslationsList = "GetStepParagraphTranslations";
        ...
        #region Partners Web API Actions
